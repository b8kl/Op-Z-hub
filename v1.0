...
L_1_[41].Image = "rbxassetid://114793094897882"  -- الصورة الجديدة
L_1_[41].BackgroundTransparency = 1
L_1_[41].Parent = L_1_[87]

-- حواف ناعمة وليست دائرية كاملة
L_1_[82] = Instance.new("UICorner")
L_1_[82].CornerRadius = UDim.new(0, 6)  -- حواف ناعمة بسيطة
L_1_[82].Parent = L_1_[41]

-- إضافة إطار ثابت أبيض بدون حركة
L_1_[25] = Instance.new("UIStroke", L_1_[41])
L_1_[25].Thickness = 2
L_1_[25].Color = Color3.fromRGB(255, 255, 255) -- لون أبيض ثابت
L_1_[25].ApplyStrokeMode = Enum.ApplyStrokeMode.Border

-- نظام السحب
L_1_[78] = false

L_1_[73] = function(input)
	local delta = input.Position - L_1_[33]
	L_1_[41].Position = UDim2.new(
		L_1_[92].X.Scale,
		L_1_[92].X.Offset + delta.X,
		L_1_[92].Y.Scale,
		L_1_[92].Y.Offset + delta.Y
	)
end

L_1_[41].InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		L_1_[78] = true
		L_1_[33] = input.Position
...
L_1_[41].InputChanged:Connect(function(input)
...
game:GetService("UserInputService").InputChanged:Connect(function(input)
	if L_1_[78] and input == L_1_[104] then
		L_1_[73](input)
	end
end)
